...
export function Header() {
  ...
  return (
    <header
      className="fixed inset-x-0 z-50 bg-secondary border-b border-border top-[52px] lg:top-0"
      style={{ ["--awr-bar-offset" as string]: "calc(env(safe-area-inset-top, 0px) + 52px)" }}
    >
