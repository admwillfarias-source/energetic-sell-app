...
const reviews: Review[] = [
  {
    ...
    date: "2025-03-12",
    rating: 5,
    text: "Atendimento incrível! Em menos de 30 minutos o técnico chegou e trocou a bateria do meu carro. Super recomendo!",
  },
  {
    name: "Ana P.",
    initials: "AP",
    ...
    date: "2025-02-28",
    rating: 5,
    text: "Preço justo, produto original e instalação rápida. Não preciso mais ir a uma loja.",
  },
  {
    name: "Roberto S.",
    initials: "RS",
    ...
    date: "2025-01-19",
    rating: 5,
    text: "Já é a segunda vez que peço pela AWR. Serviço de confiança!",
  },
  {
    name: "Patrícia L.",
    initials: "PL",
